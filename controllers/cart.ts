            ...
            .then(async (cart) => {
                if (!cart) {
                    ...
                    if (productObj != null) {
                        ...
                        // guardo cart para que no quede solo en la memoria e impacte en la base
                        await cart.save();
                        ...
                        res.send(cart); // mandamos el cart que se agregó
        ...
        Cart.find({}).populate('details.product').then(async (carts) => {
            carts.forEach(async cart => {
                ...
                cart.details.forEach(detail => {
                    // tsignore para que no me tire el error de que price es undefined
